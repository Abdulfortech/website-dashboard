...
document.getElementById("login-form").addEventListener("submit", function (event) {
    ...
    fetch("classes/Login.php?f=admin_login", {
        method: "POST",
        body: formData,
    })
        ...
        .then(data => {
            if (data.success) {
                ...
                message.innerHTML = '<div class="d-flex align-items-center text-white"><svg class="bi flex-shrink-0 me-2" width="24" height="24"><use xlink:href="#exclamation-circle-fill"/></svg><span class="text-white">' + data.message + '</span></div>';
