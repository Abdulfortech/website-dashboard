          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Active Wages</p>
                    <h5 class="font-weight-bolder">
                      {{number_format($activeWages, 0, ',')}}
                    </h5>
                    <p class="mb-0">
                      <span class="text-success text-sm font-weight-bolder"></span>
                      Active Wages
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Canceled Wages</p>
                    <h5 class="font-weight-bolder">
                      {{number_format($canceledWages, 0, ',')}}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6 class="float-start">Wages</h6>
              <div class="float-end">
                <a href="{{route('wages.add')}}" class="float-end btn btn-primary btn-sm" ><i class="fa fa-plus"></i> Add</a>
                <a href="{{route('wages.printAll')}}" class="float-end btn btn-primary btn-sm mx-2"> <i class="fa fa-print"></i> Print</a>
                ...
                <table class="table align-items-center mb-0" id="datatable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary font-weight-bolder">Employee</th>
                  ...
                  <tbody>
                    @php($count = 1)
                      ...
                      <tr>
                          ...
                          <td>{{$wage->status}}</td>
                          <td>
                            <a href="{{route('wages.view',[$wage->id])}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                            <a href="{{route('wages.edit',[$wage->id])}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                          </td>
                      </tr>
                      @php($count++)
                      @endforeach
