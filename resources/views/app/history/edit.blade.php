        ...
        <div class="col-md-9 mx-auto">
          <div class="card mb-4">
            <div class="card-header text-center pb-0">
              ...
              <h4 class="text-center">Edit History</h4>
            </div>
            <div class="card-body px-2 pt-0 pb-2">
                <form id="addProductForm" enctype="multipart/form-data" action="{{route('history.update', [$history->id])}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="date" value="{{$history->date}}" type="date" required>
                                @error('date')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="product_id" required>
                                    <option value="{{$history->product_id}}">{{$history->product->title}}</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="department" id="addProductDepartment" required>
                                    <option value="{{$history->department}}">{{$history->department}}</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="quantity" value="{{$history->quantity}}" required>
                                @error('quantity')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="amount" value="{{$history->amount}}" required>
                                @error('amount')
                                <span class="text-danger small">{{ $message}}</span>
                                @enderror
                            </div>
