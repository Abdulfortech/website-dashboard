        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="data">
                            <strong>Active Orders :</strong> {{$activeOrders}}
                        </div>
                    </td>
                    <td>
                        <div class="data">
        ...
        <table>
            <tbody>
                <tr>
                    <td>
                        <div class="data">
                            <strong>Canceled Orders :</strong> {{$canceledOrders}}
                        </div>
                    </td>
                    <td>
                        <div class="data">
                    ...
                    <td>
                        <div class="data">
                            <strong>Balance:</strong>N {{number_format($balanceAmount)}}
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>N {{number_format($Order->balance)}}</td>
